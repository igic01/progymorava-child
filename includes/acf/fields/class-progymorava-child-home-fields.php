...
class Progymorava_Child_Home_Fields {
	...
	public static function register_fields() {
		...
		$fields->field( 'promo_gallery_eyebrow', 'Malý nadpis fotografickej karty', 'home_promo_gallery_eyebrow', 'text', 'ProGym v obrazoch' );
		$fields->field( 'promo_gallery_title', 'Nadpis fotografickej karty', 'home_promo_gallery_title', 'text', 'Nahliadni do ProGym' );
		$fields->field( 'promo_gallery_description', 'Popis fotografickej karty', 'home_promo_gallery_description', 'textarea', 'Pozri si priestory, v ktorých môžeš každý deň pracovať na svojej sile, kondícii a zdraví.', $textarea_settings );
