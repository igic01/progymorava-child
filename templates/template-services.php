					...
					<div class="pg-coaches__list" aria-label="Gym coaches">
						<?php foreach ( $coaches as $index => $coach ) : ?>
							<button class="pg-coach-card" type="button" data-coach-card aria-haspopup="dialog">
								...
								<span class="pg-coach-card__content"><span class="pg-coach-card__name"><?php echo esc_html( $coach['name'] ); ?></span><span class="pg-coach-card__role"><?php echo esc_html( $coach['role'] ); ?></span><span class="pg-coach-card__more">View profile <b aria-hidden="true">&rarr;</b></span></span>
